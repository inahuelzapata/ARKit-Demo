...
class FocusSquare: SCNNode {
    ...
    static let primaryColor = #colorLiteral(red: 0.7450980544, green: 0.1568627506, blue: 0.07450980693, alpha: 1)
    static let primaryColorLight = #colorLiteral(red: 1, green: 0.1491314173, blue: 0, alpha: 1)
